...
import { ArrowRight, Calculator, Home, ChevronsRight } from 'lucide-react';
...
export const metadata: Metadata = {
    title: 'Mortgage & Real Estate Calculators | MyToolHub',
    description: 'A collection of mortgage and real estate calculators to help you with your home buying journey.'
};
  ...
  return (
    <TooltipProvider>
      <header className="sticky top-0 z-30 hidden h-14 items-center gap-4 border-b bg-background/80 px-6 backdrop-blur-sm md:flex">
        <h1 className="font-headline text-xl font-semibold">Mortgage & Real Estate Calculators</h1>
      </header>
